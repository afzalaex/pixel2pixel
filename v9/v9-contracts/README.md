# Pixel2Pixel v9 Contracts

v9 contracts intentionally inherit the v8 contract set without mechanics changes.
...
UI rehearsal note:
- For full user-path validation (seeding presence + auction controls), use `v9/v9-app` routes:
  - `/`
  - `/auction`
  - `/final`
